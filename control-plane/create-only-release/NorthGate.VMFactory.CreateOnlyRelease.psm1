...
function Get-NorthGateCreateOnlyFixedCatalog {
    ...
    $fleet = @(
        ...
        New-NgcorFleetEntry 'NG-VM-019' 'NG-MAIL-EXT01' 'persistent' 2 2048 2048 4096 40 'debian-12.12.0-amd64-netinst' $debian 704643072 'linux-gen2' 'volume-d' 'external-mail' 240 'debian12-mail-external' 'bronze' 'linux-server-keyonly-admin'
        New-NgcorFleetEntry 'NG-VM-020' 'NG-MAIL-INT01' 'persistent' 2 2048 4096 8192 80 'debian-12.12.0-amd64-netinst' $debian 704643072 'linux-gen2' 'volume-d' 'mail-internal' 120 'debian12-mail-internal' 'silver' 'linux-server-keyonly-admin'
        ...
        New-NgcorFleetEntry 'NG-VM-013' 'NG-MGR-01' 'persistent' 2 4096 4096 6144 80 'windows-11-25h2-english-x64' $windows 7736125440 'windows-gen2' 'volume-f' 'users-workstations' 110 'windows11-manager' 'bronze' 'windows-domain-managed'
        New-NgcorFleetEntry 'NG-VM-014' 'NG-IT-01' 'persistent' 4 4096 8192 12288 100 'windows-11-25h2-english-x64' $windows 7736125440 'windows-gen2' 'volume-f' 'it-admin-workstations' 130 'windows11-it-admin' 'silver' 'windows-privileged-workstation'
        New-NgcorFleetEntry 'NG-VM-015' 'NG-CYBER-01' 'persistent' 4 4096 8192 12288 120 'windows-11-25h2-english-x64' $windows 7736125440 'windows-gen2' 'volume-f' 'cyber-workstations' 140 'windows11-cyber' 'silver' 'windows-privileged-workstation'
        ...
        New-NgcorFleetEntry 'NG-VM-021' 'NG-KALI-EXT01' 'persistent' 4 4096 4096 12288 100 'kali-2026.2-installer-netinst-amd64' $kali 779091968 'linux-gen2' 'volume-d' 'sim-wan' 250 'kali-external-lab' 'bronze' 'kali-lab-keyonly-admin'
    )
