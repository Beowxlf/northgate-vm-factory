...
function Get-NgcoFixedFleetPolicy {
    ...
    $entries = @(
        ...
        New-NgcoFleetEntry 'NG-VM-019' 'NG-MAIL-EXT01' 'persistent' 2 2048 2048 4096 40 'debian-12.12-amd64-netinst' $debianHash 'linux-gen2' 'persistent-mail-protected' 'external-mail' 'debian12-mail-external' 'bronze' 'linux-server-keyonly-admin'
        New-NgcoFleetEntry 'NG-VM-020' 'NG-MAIL-INT01' 'persistent' 2 2048 4096 8192 80 'debian-12.12-amd64-netinst' $debianHash 'linux-gen2' 'persistent-mail-protected' 'mail-internal' 'debian12-mail-internal' 'silver' 'linux-server-keyonly-admin'
        ...
        New-NgcoFleetEntry 'NG-VM-013' 'NG-MGR-01' 'persistent' 2 4096 4096 6144 80 'windows-11-25h2-english-x64' $windowsHash 'windows-gen2' 'persistent-workstations' 'users-workstations' 'windows11-manager' 'bronze' 'windows-domain-managed'
        New-NgcoFleetEntry 'NG-VM-014' 'NG-IT-01' 'persistent' 4 4096 8192 12288 100 'windows-11-25h2-english-x64' $windowsHash 'windows-gen2' 'persistent-workstations' 'it-admin-workstations' 'windows11-it-admin' 'silver' 'windows-privileged-workstation'
        New-NgcoFleetEntry 'NG-VM-015' 'NG-CYBER-01' 'persistent' 4 4096 8192 12288 120 'windows-11-25h2-english-x64' $windowsHash 'windows-gen2' 'persistent-workstations' 'cyber-workstations' 'windows11-cyber' 'silver' 'windows-privileged-workstation'
        ...
        New-NgcoFleetEntry 'NG-VM-021' 'NG-KALI-EXT01' 'persistent' 4 4096 4096 12288 100 'kali-2026.2-installer-netinst-amd64' $kaliHash 'linux-gen2' 'persistent-tooling' 'sim-wan' 'kali-external-lab' 'bronze' 'kali-lab-keyonly-admin'
    )
